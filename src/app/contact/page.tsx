    ...
    <div className="py-16 bg-[#F6F8F6] min-h-[calc(100vh-64px)]">
      <div className="max-w-[1180px] mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-[#0F4C2E] mb-3">যোগাযোগ করুন</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-[#4b5563] mt-1">১৬১০৬ (টোল ফ্রি)</p>
                <p className="text-xs text-[#4b5563]">+88 02 9894350</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-[#4b5563] mt-1">info@dncc.gov.bd</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <h3 className="text-xl font-bold text-[#0F4C2E] mb-3">সরাসরি বার্তা পাঠান</h3>
                <div>
                  <label className="block text-xs font-bold text-[#182619] mb-1.5">আপনার নাম</label>
                  <input
                    type="text"
                    required
                    value={name}
                ...
                <div>
                  <label className="block text-xs font-bold text-[#182619] mb-1.5">মোবাইল নম্বর</label>
                  <input
                    type="tel"
                    required
                    value={mobile}
                ...
                <div>
                  <label className="block text-xs font-bold text-[#182619] mb-1.5">বার্তা</label>
                  <textarea
                    rows={4}
                    required
                    value={message}
                ...
                <button
                  type="submit"
                  className="w-full bg-[#0F4C2E] text-white rounded-full py-3.5 font-bold text-sm hover:bg-[#1E7A45] transition-all flex items-center justify-center gap-2"
                >
