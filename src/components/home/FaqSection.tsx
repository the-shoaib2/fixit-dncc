      ...
      <div className="max-w-[760px] mx-auto px-6">
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-2xl p-6 transition-all">
            ...
            <div className={`grid transition-[grid-template-rows,opacity] duration-300 ease-in-out ${openFaq === 0 ? 'grid-rows-[1fr] opacity-100 mt-4 pt-4 border-t border-slate-100' : 'grid-rows-[0fr] opacity-0'}`}>
          ...
          <div className="bg-white rounded-2xl p-6 transition-all">
            ...
            <div className={`grid transition-[grid-template-rows,opacity] duration-300 ease-in-out ${openFaq === 1 ? 'grid-rows-[1fr] opacity-100 mt-4 pt-4 border-t border-slate-100' : 'grid-rows-[0fr] opacity-0'}`}>
              <div className="overflow-hidden">
                <p className="text-sm text-[#4b5563] leading-relaxed">
                  {t('faq.a2')}
                </p>
          ...
          <div className="bg-white rounded-2xl p-6 transition-all">
            ...
            <div className={`grid transition-[grid-template-rows,opacity] duration-300 ease-in-out ${openFaq === 2 ? 'grid-rows-[1fr] opacity-100 mt-4 pt-4 border-t border-slate-100' : 'grid-rows-[0fr] opacity-0'}`}>
              <div className="overflow-hidden">
                <p className="text-sm text-[#4b5563] leading-relaxed">
                  {t('faq.a3')}
                </p>
