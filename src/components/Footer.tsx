...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#0C1C11] text-[#cfd8cf] pt-16 pb-10">
      <div className="max-w-[1180px] mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between gap-10 pb-10 border-b border-white/10">
          <div className="max-w-md">
            <Link href="/" className="inline-block mb-4">
              <img src="/logo/logo-light.png" alt="FixIt DNCC Logo" className="h-9 w-auto object-contain" />
            </Link>
            <p className="text-sm text-[#9fb09f] leading-relaxed">
              {t('footer.brandDesc')}
            </p>
          </div>
          <div className="flex flex-wrap gap-14">
            <div>
              <h4 className="text-xs uppercase tracking-widest text-[#7f9280] font-bold mb-4">
                {t('footer.col1')}
              </h4>
              <ul className="space-y-2.5 text-sm text-[#dfe6df]">
        ...
        <div className="pt-8 text-xs text-[#7f9280] flex flex-col sm:flex-row justify-between gap-3">
